...
| [DeepSeek](/providers/deepseek/) | DeepSeek API key | Anthropic-compatible Messages | `deepseek/<model-id>` forms and configured aliases | Native tools, thinking, images, and streaming |
